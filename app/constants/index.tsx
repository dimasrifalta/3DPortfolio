...
const projects = [
  {
    ...
    source_code_link: 'https://github.com/dimasrifalta/skripsi-ai-chat-ppt',
  ...
  },
  {
    ...
    source_code_link: 'https://github.com/dimasrifalta/ai-interview-mocker',
...

  {
    ...
    source_code_link: 'https://github.com/dimasrifalta/microsoft-loop',
    netlify_link: 'https://bucek-loop.vercel.app/',
  },
  {
    name: 'AI Room Design',
    description:
      'AI Room and Home Interior Design Experience the power of AI-driven solutions to transform your space with precision, creativity, and innovation.',
    tags: [
      {
        name: 'Neon',
        color: 'blue-text-gradient',
    ...
    image: '/projectimg/airoomredesign.webp',
    source_code_link: 'https://bucek-room-redesign.vercel.app/',
    netlify_link: 'https://bucek-room-redesign.vercel.app/',
  },
  {
    name: 'MY Memories',
    description:
